        ...
        if (pilihlihat.equals("1")) {
            ...
            if (dataKelasBisnis.size() < 1) {
                ...
                for (int i = 0; i < dataKelasBisnis.size(); i++) {
                    ...
                    System.out.println("No Pesanan       : " + dataKelasBisnis.get(i).getnopesanan());
                    System.out.println("Nama             : " + dataKelasBisnis.get(i).getnama());
                    System.out.println("Tanggal          : " + dataKelasBisnis.get(i).gettanggal());
                    System.out.println("Makapai          : " + dataKelasBisnis.get(i).getmaskapai());
                    System.out.println("Kota Asal        : " + dataKelasBisnis.get(i).getkotaasal());
                    System.out.println("Kota Tujuan      : " + dataKelasBisnis.get(i).getkotatujuan());
                    System.out.println("Jam (B/D)        : " + dataKelasBisnis.get(i).getjam());
                    System.out.println("Kelas            : " + dataKelasBisnis.get(i).getkelas());
                    System.out.println("Bagasi           : " + dataKelasBisnis.get(i).getbagasi());
                    System.out.println("Makanan          : " + dataKelasBisnis.get(i).getmakanan());
                }
                    System.out.println("═══════════════════════════════════════════");
            }
        }
            ...
            if (dataKelasEkonomi.size() < 1) {
                ...
                for (int i = 0; i < dataKelasEkonomi.size(); i++){
                    System.out.println("═══════════════════════════════════════════");
                    System.out.println("Data Tiket ke-" + urutan++);
                    System.out.println("No Pesanan       : " + dataKelasEkonomi.get(i).getnopesanan());
                    System.out.println("Nama             : " + dataKelasEkonomi.get(i).getnama());
                    System.out.println("Tanggal          : " + dataKelasEkonomi.get(i).gettanggal());
                    System.out.println("Makapai          : " + dataKelasEkonomi.get(i).getmaskapai());
                    System.out.println("Kota Asal        : " + dataKelasEkonomi.get(i).getkotaasal());
                    System.out.println("Kota Tujuan      : " + dataKelasEkonomi.get(i).getkotatujuan());
                    System.out.println("Jam (B/D)        : " + dataKelasEkonomi.get(i).getjam());
                    System.out.println("Kelas            : " + dataKelasEkonomi.get(i).getkelas());
                    System.out.println("No Kursi         : " + dataKelasEkonomi.get(i).getnokursi());
                }
                    System.out.println("═══════════════════════════════════════════");
            }
        }
